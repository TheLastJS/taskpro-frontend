...
const BoardModal = ({
  ...
  const [background, setBackground] = useState(
    initialBoard?.background || backgroundTypes[0].name
  );
  ...
  // Temaya göre renkler
  const bgColor = theme?.card || "#181818";
  const textColor = theme?.text || "#fff";
  const inputBg = theme?.inputBg || "#232323";
  const inputText = theme?.inputText || "#fff";
  const inputBorder = theme?.inputBorder || "#bedbb0";
  const accent = theme?.accent || "#bedbb0";
  const borderColor = theme?.border || "#bedbb0";
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ marginBottom: 16, color: textColor }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ marginBottom: 4, color: textColor }}>Icons</div>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ marginBottom: 4, color: textColor }}>Background</div>
            <div
              style={{
                display: "flex",
                gap: 8,
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
            <button
              ...
              style={{
                ...
                padding: "10px 0",
                background: accent,
                color: theme?.mode === "light" ? "#161616" : "#232323",
                border: "none",
                borderRadius: 8,
                fontWeight: 600,
                fontSize: 16,
